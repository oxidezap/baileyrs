...
export type MessageCryptoRuntime = {
...
export function decryptPollVote(
	...
	crypto: MessageCryptoRuntime
) {
	return proto.Message.PollVoteMessage.decode(
		crypto.decryptPollVotePayload(encPayload!, encIv!, pollEncKey, pollMsgId, pollCreatorJid, voterJid)
	)
}
...
export function decryptEventResponse(
	...
	return proto.Message.EventResponseMessage.decode(
		crypto.decryptEventResponsePayload(encPayload!, encIv!, eventEncKey, eventMsgId, eventCreatorJid, responderJid)
	)
}
