import type { QueryIds as QueryIdsType, XWAPaths as XWAPathsType } from '../Compatibility/public-api/enum-types.ts'
...
} as const) as unknown as typeof XWAPathsType
...
} as const) as unknown as typeof QueryIdsType
